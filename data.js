/* ملف بيانات موقع ITQAN — آخر تحديث: ٢٠‏/٩‏/٢٠٢٦، ١٠:٢٣:٠٤ م */
window.SITE = {
  "meta": {
  ...
  "hero": {
    ...
    "titleLine1": "نصنع الجودة لتليق",
    "titleLine2": "بواجهة مستقبلك",
    "highlight": "الجودة",
    "subtitle": "شبابيك، أبواب، واجهات زجاجية، ومطابخ ألوميتال وأنظمة شتر مصممة بأعلى معايير الدقة والاحترافية.\nضمان ممتد وتنفيذ مثالي يجمع بين المتانة والأناقة العصرية.",
  ...
  "about": {
    ...
    "titleLine2": "أساساً للثقة",
    "image": "images/about-main.webp",
    "paragraphs": [
      "تأسست شركة إتقان لتكون من الشركات الرائدة في مصر في مجال تصنيع وتركيب أنظمة الألوميتال والـ UPVC والشتر. منذ نشأتها، ركزت الشركة على تقديم حلول هندسية عالية الجودة تلبي احتياجات المشاريع السكنية والتجارية، بالاعتماد على خامات معتمدة وفريق فني وهندسي على أعلى مستوى.",
      "تميزت إتقان عبر مشاريعها المتعددة بالالتزام الدقيق بالمواعيد، جودة التشطيب، وخدمة ما بعد البيع، مما أكسبها ثقة العملاء والشركات والمؤسسات الكبرى."
    ],
    "bullets": [
      "قطاعات ألوميتال معتمدة من السلام وشريف علي حسن",
      "دهانات إلكتروستاتيك معتمدة من الدولية والألوان",
      "شراكة مع كبرى الشركات الموردة للشتر: النيل ومدار",
      "مواتير شتر إيطالية وإسبانية وفرنسية بضمان يصل إلى 5 سنوات",
  ...
  "services": {
    ...
    "titleLine2": "حتى التركيب النهائي",
    "subtitle": "نقدم منظومة متكاملة تشمل أنظمة الألوميتال والـ UPVC والشتر لكل أنواع المشاريع السكنية والتجارية.",
    "items": [
      {
        "size": "large",
        "image": "images/srv-windows.webp",
        "title": "شبابيك UPVC وألوميتال",
        "text": "نظام شبابيك متطور يوفر أقصى درجات العزل الصوتي والحراري. الألوميتال هو النظام الأكثر استخداماً في مصر لمرونته وقوته وتنوع تصميماته.",
        "features": [
          "المفصلي (Casement) — إحكام ضد الهواء والمياه",
          "السحاب (Sliding) — عملي للمساحات الصغيرة",
          "الفولدينج (Folding) — فتحة أكبر للفيلات",
          "زجاج سنجل / دبل / تريبل / LOW-E"
        ]
      },
      {
        "size": "large",
        "image": "images/srv-doors.webp",
        "title": "أبواب ألوميتال داخلية وخارجية",
        "text": "أبواب ألوميتال متينة بتصميمات عصرية، توفر الأمان والخصوصية مع مقاومة عالية للعوامل الجوية وتغيرات الحرارة.",
        "features": [
          "أبواب مداخل سكنية وتجارية",
          "أبواب مكاتب زجاجية (بارتيشن)",
          "مقاوم للصدأ والعوامل الجوية",
          "إكسسوارات تركية وأوروبية أصلية"
        ]
      },
      {
        "size": "small",
        "image": "images/srv-facades.webp",
        "title": "واجهات كرتن وول وStructural Glazing",
        "text": "واجهات زجاجية احترافية للمباني التجارية، مظهر عصري راقٍ مع أعلى معايير الأمان والعزل.",
        "features": [
          "Curtain Wall بالمواصفات الدولية",
          "Structural Glazing",
          "أسقف زجاجية وأفنية داخلية"
        ]
      },
      {
        "size": "small",
        "image": "images/srv-kitchens.webp",
        "title": "مطابخ ألوميتال",
        "text": "مطابخ ألوميتال بتصميمات عصرية، مقاومة للرطوبة والحرارة، بألوان متعددة تناسب كل ذوق.",
        "features": [
          "مقاوم للرطوبة والحرارة",
          "ألوان: مات، لامع، خشبي",
          "دهانات إلكتروستاتيك من الدولية"
        ]
      },
      {
        "size": "small",
        "image": "images/srv-shutters.jpg",
        "title": "أنظمة الشتر",
        "text": "حماية من الشمس والأتربة والضوضاء والسرقة، بتشغيل يدوي أو كهربائي وضمان حتى 5 سنوات.",
        "features": [
          "شرايح النيل ومدار",
          "مواتير إيطالية وإسبانية وفرنسية",
          "تشغيل كهربائي أو يدوي"
        ]
      }
    ]
  },
  ...
  "contactSection": {
    ...
    "subtitle": "معاينة مجانية — عرض سعر فوري — بدون أي التزام",
    "formTitle": "أرسل رسالة",
    "formButton": "إرسال الطلب عبر واتس آب ✉️",
    "whatsappButton": "تواصل عبر واتس آب",
    "serviceOptions": [
      "شبابيك UPVC",
      "شبابيك ألوميتال",
      "أبواب ألوميتال",
  ...
  "footer": {
    ...
    "copyright": "شركة ITQAN للألوميتال والـ UPVC والشتر. جميع الحقوق محفوظة."
  }
};
